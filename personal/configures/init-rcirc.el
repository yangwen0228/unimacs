...
;; Change user info
(setq rcirc-default-nick "yangwen0228")
(setq rcirc-default-user-name "yangwen0228")
(setq rcirc-default-full-name "Yang Wen")

(let ((auth-file (expand-file-name "private/.auth-rcirc.el" my-personal-dir)))
...
(defvar my-rcirc-log-dir (expand-file-name ".irclog/" my-personal-dir))
